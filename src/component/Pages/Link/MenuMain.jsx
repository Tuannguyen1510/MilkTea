        ...
        <div className="row">
          <div className="menuMain-left col-3">
            <div className="content">
              <NavLink className="nav-link" to='/home/matcha'>
              ...
              {/*  */}
              <NavLink className="nav-link" to='/home/bub' >
                <div className="menuName row">
              ...
              {/*  */}
              <NavLink className="nav-link" to='/home/red'>
                <div className="menuName row">
              ...
              {/*  */}
              <NavLink className="nav-link" to='/home/mango'>
                <div className="menuName row">
                  <img src="./img/icon4.png" alt="" class="col-3" />
              ...
              {/*  */}
              <NavLink className="nav-link" to='/home/peach'>
                <div className="menuName row">
