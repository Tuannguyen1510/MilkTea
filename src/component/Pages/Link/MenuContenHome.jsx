...
export default class MenuContenHome extends Component {
  render() {
    return (
        <div className="row">
        <div className="menuMain-left col-3">
          <div className="content">
            <NavLink className="nav-link" to='/menu/matchamenu'>
            ...
            {/*  */}
            <NavLink className="nav-link" to='/menu/bubmenu' >
              <div className="menuName row">
            ...
            {/*  */}
            <NavLink className="nav-link" to='/menu/redmenu'>
              <div className="menuName row">
            ...
            {/*  */}
            <NavLink className="nav-link" to='/menu/mangomenu'>
              <div className="menuName row">
                <img src="./img/icon4.png" alt="" class="col-3" />
            ...
            {/*  */}
            <NavLink className="nav-link" to='/menu/peachmenu'>
              <div className="menuName row">
